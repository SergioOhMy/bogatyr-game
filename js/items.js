...
export const weaponCatalog = [
    ...
    { id: 'plain_sword', name: 'Простой меч', icon: '⚔️',
        baseEffect: { stat: 'dmg', value: 0.04 }, bonusFor: null, sellPrice: 40 },
    { id: 'oak_staff', name: 'Дубовый посох', icon: '🪵',
    ...
    { id: 'moonfang_volkolak', name: 'Клык Луны', icon: '🌕',
